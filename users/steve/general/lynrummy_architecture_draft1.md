# LynRummy architecture — drafting copy

**NOTE:** This was the drafting / annotation surface.
The parked version lives at:

    games/lynrummy/ARCHITECTURE.md

Future edits should go to the parked location. This essay
remains as the paper trail of comments that shaped the doc.
